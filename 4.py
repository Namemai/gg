...
poll = LinePoll(cl)
call = cl
creator = ["uc66e45201d1612eb4ce7b3a86bac4685","ue19a299b94742f369cd1afe3d3f6f194]
owner = ["uc66e45201d1612eb4ce7b3a86bac4685","ue19a299b94742f369cd1afe3d3f6f194]
admin = ["uc66e45201d1612eb4ce7b3a86bac4685","ue19a299b94742f369cd1afe3d3f6f194]
staff = ["uc66e45201d1612eb4ce7b3a86bac4685","ue19a299b94742f369cd1afe3d3f6f194]
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "เปิดบอท4":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "เปิดระบบทำงานคิก4ตัวแล้ว..")
                                
                        elif cmd == "ปิดบอท4":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "ปิดระบบทำงานคิก4ตัวแล้ว")
                        ...
                        elif text.lower() == "4มิด":
                               cl.sendMessage(msg.to, msg._from)

                        elif ("4มิด " in msg.text):
                          if wait["selfbot"] == True:
                            if msg._from in admin:
...
#===========BOT UPDATE============#
                        elif cmd == "4tag" or text.lower() == '4แทค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    km.sendMessage(msg.to, "พร้อมคุ้มกันเจ้านายค่ะ")
                                except:
                                    pass
